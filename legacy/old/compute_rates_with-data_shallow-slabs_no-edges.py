...
for i in range(0,data.shape[0]):
	if np.isnan(data[i,15]) == False and  np.isnan(data[i,9]) == False and np.isnan(data[i,3]) == False and data[i,7] <= 680.0 and data[i,24] == 0:
...
for i in range(0,data.shape[0]):
	if np.isnan(data[i,15]) == False and  np.isnan(data[i,9]) == False and np.isnan(data[i,6]) == False and data[i,7] <= 680.0 and data[i,24] == 0:
...
for i in range(0,data.shape[0]):
	if np.isnan(data[i,15]) == False and  np.isnan(data[i,9]) == False and np.isnan(data[i,20]) == False and data[i,7] <= 680.0 and data[i,24] == 0:
...
for i in range(0,data.shape[0]):
	if np.isnan(data[i,15]) == False and  np.isnan(data[i,9]) == False and np.isnan(data[i,7]) == False and data[i,7] <= 680.0 and data[i,24] == 0:
...
for i in range(0,data.shape[0]):
	if np.isnan(data[i,16]) == False and  np.isnan(data[i,9]) == False and np.isnan(data[i,13]) == False and data[i,7] <= 680.0 and data[i,24] == 0:
...
plt.savefig('test_with-data_shallow-slabs_no-edges.png', bbox_inches='tight')
